# [Shortcut](shortcuts.md): COORDINATION_SHELL_FUNCTION

| Description    | Usage |
|:--------|:--------:|
| Calculate an arbitrary function of all the bond vectors in the first coordination sphere of an atom | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg)|
 | **output value** | **type** |
