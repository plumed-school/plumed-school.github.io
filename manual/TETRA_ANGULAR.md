# [Shortcut](shortcuts.md): TETRA_ANGULAR

| Description    | Usage |
|:--------|:--------:|
| Calculate the angular tetra CV | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg)|
 | **output value** | **type** |
