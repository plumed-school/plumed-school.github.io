# [Shortcut](shortcuts.md): PLANES

| Description    | Usage |
|:--------|:--------:|
| Calculate the components of the normal to the plane containing three atoms | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg) | 
