# [Shortcut](shortcuts.md): COORDINATION_MOMENTS

| Description    | Usage |
|:--------|:--------:|
| Calculate moments of the distribution of distances in the first coordination sphere | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg)|
 | **output value** | **type** |
