# [Shortcut](shortcuts.md): COORDINATIONNUMBER

| Description    | Usage |
|:--------|:--------:|
| Calculate the coordination numbers of atoms so that you can then calculate functions of the distribution of | [![used in 4 tutorials](https://img.shields.io/badge/tutorials-4-green.svg)](https://www.plumed-tutorials.org/browse.html?search=COORDINATIONNUMBER)[![used in 29 eggs](https://img.shields.io/badge/nest-29-green.svg)](https://www.plumed-nest.org/browse.html?search=COORDINATIONNUMBER)|
 | **output value** | **type** |
