...
| Description    | Usage |
|:--------|:--------:|
| Bayesian single-structure and ensemble refinement with cryo-EM maps. | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)[![used in 4 eggs](https://img.shields.io/badge/nest-4-green.svg)](https://www.plumed-nest.org/browse.html?search=EMMIVOX) | 
