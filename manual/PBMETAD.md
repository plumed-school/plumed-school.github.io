...
| Description    | Usage |
|:--------|:--------:|
| Used to performed Parallel Bias metadynamics. | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)[![used in 31 eggs](https://img.shields.io/badge/nest-31-green.svg)](https://www.plumed-nest.org/browse.html?search=PBMETAD) | 
