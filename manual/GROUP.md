...
| Description    | Usage |
|:--------:|:--------:|
| Define a group of atoms so that a particular list of atoms can be referenced with a single label in definitions of CVs or virtual atoms. | [![used in 5 tutorials](https://img.shields.io/badge/tutorials-5-green.svg)](https://plumed-school.github.io/browse.html?search=GROUP)[![used in 113 eggs](https://img.shields.io/badge/nest-113-green.svg)](https://www.plumed-nest.org/browse.html?search=GROUP) | 
