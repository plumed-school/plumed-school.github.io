# [Shortcut](shortcuts.md): ZANGLES

| Description    | Usage |
|:--------|:--------:|
| Calculate the angle between an arbitrary vector and the positive z direction | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)[![used in 1 eggs](https://img.shields.io/badge/nest-1-green.svg)](https://www.plumed-nest.org/browse.html?search=ZANGLES) | 
