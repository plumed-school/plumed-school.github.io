...
| Description    | Usage |
|:--------:|:--------:|
| Pass domain decomposed properties of atoms to PLUMED | [![used in 1 tutorials](https://img.shields.io/badge/tutorials-1-green.svg)](https://plumed-school.github.io/browse.html?search=DOMAIN_DECOMPOSITION)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg) | 
