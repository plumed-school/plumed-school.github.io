# [Shortcut](shortcuts.md): LOCAL_CRYSTALINITY

| Description    | Usage |
|:--------|:--------:|
| Calculate the local crystalinity symmetry function | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg)|
 | **output value** | **type** |
