# [Action](actions.md): BF_POWERS

| Description    | Usage |
|:--------|:--------:|
| Polynomial power basis functions. | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)![used in 0 eggs](https://img.shields.io/badge/nest-0-red.svg) | 
...
| NORMALIZATION | optional | not used | The normalization factor that is used to normalize the basis functions |
