...
| Description    | Usage |
|:--------|:--------:|
| This command is used to provide information on the molecules that are present in your system. | [![used in 8 tutorials](https://img.shields.io/badge/tutorials-8-green.svg)](https://www.plumed-tutorials.org/browse.html?search=MOLINFO)[![used in 88 eggs](https://img.shields.io/badge/nest-88-green.svg)](https://www.plumed-nest.org/browse.html?search=MOLINFO) | 
