# [Shortcut](shortcuts.md): SMAC

| Description    | Usage |
|:--------|:--------:|
| Calculate the SMAC order parameter for a set of molecules | ![used in 0 tutorials](https://img.shields.io/badge/tutorials-0-red.svg)[![used in 1 eggs](https://img.shields.io/badge/nest-1-green.svg)](https://www.plumed-nest.org/browse.html?search=SMAC)|
 | **output value** | **type** |
