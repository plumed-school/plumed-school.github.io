...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UNITS,METAD,RESTART,RESTRAINT,EXTENDED_LAGRANGIAN,TORSION,MOLINFO,WHOLEMOLECULES,PRINT,UPPER_WALLS,FLUSH,LOWER_WALLS,GROUP,DISTANCE,COORDINATION,COM" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
