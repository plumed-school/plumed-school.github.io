...
<div class="headerBadge"><a href="SymmetryFunction.md_working_1.dat.plumed.stderr"><img src="https://img.shields.io/badge/v2.10-passing-green.svg" alt="tested onv2.10" /></a></div>
...
<div class="containerBadge">
<div class="headerBadge"><a href="SymmetryFunction.md_working_2.dat.plumed.stderr"><img src="https://img.shields.io/badge/v2.10-passing-green.svg" alt="tested onv2.10" /></a></div>
...
<pre class="plumedlisting">
<span style="color:blue" class="comment"># Calculate the contact matrix and the three matrices that contain the components of the </span>
<span style="color:blue" class="comment"># vectors connecting atom i and atom j.  In other words, calculate four 7x7 matrices</span>
...
<div class="containerBadge">
<div class="headerBadge"><a href="SymmetryFunction.md_working_3.dat.plumed.stderr"><img src="https://img.shields.io/badge/v2.10-passing-green.svg" alt="tested onv2.10" /></a></div>
...
<span style="color:blue" class="comment"># This applies the function to the three input matrices element-wise and thus outputs </span>
<span style="color:blue" class="comment"># a 7x7 matrix</span>
...
<span style="color:blue" class="comment"># Again we are applying the function element wise to the five input matrices and thus </span>
<span style="color:blue" class="comment"># outputting a 7x7 matrix</span>
