...
Download: [zipped raw stdout](GAT_SAFE_README.md_working_4.dat.plumed.stdout.txt.zip) - [zipped raw stderr](GAT_SAFE_README.md_working_4.dat.plumed.stderr.txt.zip) 
{% raw %}
<pre>
