...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=EFFECTIVE_ENERGY_DRIFT,METAD,COMBINE,RMSD,CUSTOM,WHOLEMOLECULES,PRINT,DEBUG,GROUP,DISTANCE,COORDINATION" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
