...
flowchart TB;
  ...
  click I "Installation.html" "Some advice on installing PLUMED so you can do this exercise"
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UNITS,CONVERT_TO_FES,UPPER_WALLS,READ,RESTRAINT,PRINT,CONSTANT,CUSTOM,DISTANCE,COM,COORDINATIONNUMBER,METAD,AVERAGE,DUMPGRID,HISTOGRAM,REWEIGHT_BIAS" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
