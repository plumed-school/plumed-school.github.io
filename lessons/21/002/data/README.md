...
fes: CONVERT_TO_FES ARG=__FILL__ TEMP=1  # This sets k_B T = 1 
DUMPGRID ARG=__FILL__ FILE=fes.dat
```
...
...
DUMPGRID ARG=__FILL__ FILE=hist.dat STRIDE=1000
```
...
...
DUMPGRID ARG=hh FILE=my_histogram.dat STRIDE=2500
```
