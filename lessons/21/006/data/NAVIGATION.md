...
```
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=HISTOGRAM,DUMPPDB,DUMPVECTOR,TORSION,DUMPGRID,UNITS,DUMPMULTICOLVAR,MORE_THAN,SKETCHMAP,PATH,PRINT,FCCUBIC,GROUP,COMMITTOR,CLASSICAL_MDS,PARABETARMSD,ANTIBETARMSD,PCA,ALPHARMSD,MOLINFO,COLLECT_FRAMES,LANDMARK_SELECT_FPS,RMSD,PROJECT_POINTS,COORDINATIONNUMBER,PCAVARS" target="_blank">Click here</a> to open manual pages for actions discussed in this tutorial.</b>
{% endraw %}
